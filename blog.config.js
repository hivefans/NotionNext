...
const BLOG = {
  API_BASE_URL: process.env.API_BASE_URL || 'https://hivefans.notion.site/api/v3', // API默认请求地址,可以配置成自己的地址例如：https://[xxxxx].notion.site/api/v3
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'hivefans', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的IT老兵', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.web3loc.com', // 网站地址
  ...
  GREETING_WORDS:
    process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi，我是一个程序员, Hi，我是一个打工人,Hi，我是一个干饭人,欢迎来到我的博客🎉',
